function [ featureVectors ] = featureExtractionVisualToCombine(input)
...
%%  currently teetholeCount WEIGHT = 4 + DCT
featureVectorsNum = 4 + DCTVectorsNum;
...
%             end
    ...
    %% normalizing the markers
    % distMarkers = distMarkers / norm(distMarkers);
    ...
    if(j~=1)
        ...
        featureVector = [teethHoleCount,teethHoleCount,teethHoleCount,teethHoleCount,dctFinal];
